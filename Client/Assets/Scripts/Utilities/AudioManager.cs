...
public class AudioManager : MonoBehaviour {
    ...
    public static void PlayAudio (GameObject sourceObj, eAudioType type, string name, float volumn = -1, bool isloop = false)
    {

        string route = "";
        switch (type)
        {
            case eAudioType.Audio_Skill:
                {
                    route = "Audios/Skill/";
                    break;
                }
